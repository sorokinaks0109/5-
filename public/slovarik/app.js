  ...
  function viewWords() {
    ...
    return `
      ...
      <p class="muted">${+S.grade <= 2
        ...
        : +S.grade >= 6
          ? `Слова из орфографического словаря учебника «Русский язык. ${S.grade} класс» Ладыженской, Баранова, Тростенцовой (${{ 6: 'ФГОС, 2023', 7: '2-е издание, 2020', 8: '5-е издание, 2023' }[S.grade]}).`
